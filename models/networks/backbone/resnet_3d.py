...
from TPN.models.networks.network_libs import Conv3DBN, MaxPool3D
    ...
    def __init__(self, inplanes, planes, spatial_stride=1, temporal_stride=1,
        ...
        if if_inflate:
            if inflate_style == '3x1x1':
                self.conv1 = Conv3x1x1BN(inplanes, planes, act='relu')
                self.conv2 = Conv1x3x3BN(planes, planes, spatial_stride, temporal_stride, act='relu')
            else:
        ...
        self.conv3 = Conv1x1x1BN(planes, planes * self.expansion)
...
if __name__ == '__main__':
    ...
    with fluid.dygraph.guard():
        ...
        resnet3d = ResNet3D(50, inflate_freqs=(0, 0, 1, 1))
